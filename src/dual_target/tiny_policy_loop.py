"""DT3 model loop derived from DT2 runner d506b4b; frozen scorer unchanged."""
    ...
    *,
    ...
    writer = EpisodeEvidenceWriter(episode_root, {
        **scene_metadata,
        ...
        "model_controller": policy_client.metadata,
    })
    ...
    try:
        ...
        for step_index in range(args.max_env_steps):
            ...
            writer.pre_action({
                "event": "pre_action", "phase": "policy", "sim_time_s": time_before,
                ...
                "body_velocity_body": body_before, "raw_action": command,
            ...
            writer.post_step({
                "event": "post_step", "phase": "policy", "sim_time_before_s": time_before,
