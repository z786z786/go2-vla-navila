...
struct UiStatusSnapshot
{
    ...
    bool d435iActive = false;
    bool d435iDegraded = false;
    std::string d435iDegradedReason;
    bool d435iColorValid = false;
    bool d435iColorFresh = false;
    bool d435iDepthValid = false;
    bool d435iDepthFresh = false;
    uint64_t d435iColorSeq = 0;
    uint64_t d435iDepthSeq = 0;
    double d435iColorAgeSeconds = -1.0;
    double d435iDepthAgeSeconds = -1.0;
    std::string d435iBagPath;
...
struct WebUiServerConfig
{
    ...
    std::function<std::vector<uint8_t>()> d435iColorJpegProvider;
    std::function<std::vector<uint8_t>()> d435iDepthJpegProvider;
    std::function<UiImageFrame(uint64_t, int)> nextD435iColorFrameProvider;
    std::function<UiImageFrame(uint64_t, int)> nextD435iDepthFrameProvider;
};
